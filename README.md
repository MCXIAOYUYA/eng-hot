...
- [ ] **拆主轴**:`今日`(真时效:Breaking News English + 考试节点)与
      `素材库`(evergreen,按主题/难度)分开。现在 44 条里 22 条是常青内容,
      它们的「热度」是个常数 —— 混在一条热度流里,两边都被拖累
- [ ] **今日 5 分钟**:首页收敛成固定剂量(1 条新闻 + 5 个表达 + 1 次跟读),
      localStorage 记连续天数。收藏是囤积机制,打卡才是学习机制
- [ ] 生词本:重点表达一键收藏,导出 Anki
- [ ] 信源扩充:可可英语、扇贝、知乎英语话题
